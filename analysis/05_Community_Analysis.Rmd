...
scaled_total_seqs_df %>%
  ...
  labs(title = "Scaled Sequencing Depth at 2000") + 
  theme_bw()
...
soren_gut_section_pcoa <- plot_ordination(
  ...
  title = "Sorensen PCoA") +
  geom_point(size=5, alpha = 0.5, aes(color = env_local_scale)) +
...
- Axis 1 = ~58.5% of variation  
- Axis 2 = ~22.5% of variation 
...
- Axis 1 = ~76.1% of variation  
- Axis 2 = ~10.8% of variation 
...
scaled_sorensen_dist <- phyloseq::distance(scaled_rooted_physeq, 
...
adonis2(scaled_sorensen_dist ~ env_local_scale, data = metadata)
adonis2(scaled_bray_dist ~ env_local_scale, data = metadata)
...
level_order <- 
  c("G196_IV", "G197_IV", "G198_IV", "G199_IV", "G200_IV", 
    "G197_V", "G198_V", "G200_V", "G201_V") 
...
phylum_df %>%
  ...
  ggplot(aes(x = factor(Sample.Name, level = level_order),
 # ggplot(aes(x = Sample.Name,
             y = Abundance, fill = Phylum)) +
  #facet_grid(.~gut_section) + 
  geom_bar(stat = "identity", color = "black") +
  labs(title = "Gut Section Phylum Composition", x= "Sample", 
